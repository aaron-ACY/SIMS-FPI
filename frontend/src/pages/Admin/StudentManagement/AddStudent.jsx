    ...
    <div className="max-w-7xl mx-auto space-y-4 animate-fade-in pb-4 px-4">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 bg-white p-6 rounded-2xl border border-gray-100 shadow-sm">
        <div className="flex items-center gap-4">
          <div>
            <h1 className="text-3xl font-black text-[#08060d] tracking-tight">Add student</h1>
        ...
        <div className="md:col-span-2">
          <Card className="border-gray-100 shadow-xl shadow-gray-200/10 rounded-2xl">
            <CardHeader className="border-b border-gray-50 px-6 py-3">
              <CardTitle className="text-lg font-black text-[#08060d]">Thông tin cá nhân</CardTitle>
            </CardHeader>
            <CardContent className="px-6 py-4 space-y-4">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-x-6 gap-y-3">
                ...
                <div className="space-y-1">
                  ...
                  <div className="relative">
                    ...
                    <input type="text" placeholder="Nguyễn Văn A" className={inputClasses} />
                  </div>
                </div>
                ...
                <div className="space-y-1">
                  ...
                  <div className="relative">
                    ...
                    <input type="email" placeholder="example@edu.vn" className={inputClasses} />
                  </div>
                </div>
              ...
              <h3 className="text-lg font-black text-[#08060d] mb-2">Thông tin học thuật</h3>
              
              <div className="grid grid-cols-1 md:grid-cols-2 gap-x-6 gap-y-3">
                {/* Major */}
                <div className="space-y-1">
                  <label className={labelClasses}>Ngành học</label>
                  <div className="relative">
                    <div className="absolute left-4 top-1/2 -translate-y-1/2 text-gray-300 scale-90">
                      <Icons.Book />
                    </div>
                ...
                <div className="space-y-1">
                  ...
                  <div className="relative">
                    ...
                    <input type="text" placeholder="K65-CNTT" className={inputClasses} />
                  </div>
                </div>
              </div>
