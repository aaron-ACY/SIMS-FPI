  ...
  return (
    <div className="max-w-4xl mx-auto space-y-4 animate-fade-in pb-4 px-4">
      ...
      <div className="bg-white p-6 rounded-2xl border border-gray-100 shadow-sm">
        <h1 className="text-3xl font-black text-[#08060d] tracking-tight">Add subject</h1>
      ...
      <Card className="border-gray-100 shadow-xl shadow-gray-200/10 rounded-2xl overflow-hidden">
        <CardHeader className="border-b border-gray-50 px-8 py-5">
          <CardTitle className="text-lg font-black text-[#08060d]">Thông tin môn học</CardTitle>
        </CardHeader>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="md:col-span-2 space-y-1">
              ...
              <div className="relative">
                ...
                <input type="text" placeholder="Ví dụ: Lập trình hướng đối tượng" className={inputClasses} />
              </div>
            </div>
            ...
            <div className="space-y-1">
              ...
              <div className="relative">
                ...
                <input type="text" placeholder="SUBXXX" className={inputClasses} />
              </div>
            </div>
            ...
            <div className="space-y-1">
              ...
              <div className="relative">
                ...
                <input type="number" placeholder="2, 3, 4..." className={inputClasses} />
              </div>
            </div>
