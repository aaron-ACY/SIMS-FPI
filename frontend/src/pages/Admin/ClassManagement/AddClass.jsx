  ...
  return (
    <div className="max-w-4xl mx-auto space-y-4 animate-fade-in pb-4 px-4">
      ...
      <div className="bg-white p-6 rounded-2xl border border-gray-100 shadow-sm">
        <h1 className="text-3xl font-black text-[#08060d] tracking-tight">Add class</h1>
      ...
      <Card className="border-gray-100 shadow-xl shadow-gray-200/10 rounded-2xl overflow-hidden">
        <CardHeader className="border-b border-gray-50 px-8 py-5">
          <CardTitle className="text-lg font-black text-[#08060d]">Thông tin lớp sinh hoạt</CardTitle>
        </CardHeader>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="space-y-1">
              ...
              <div className="relative">
                ...
                <input type="text" placeholder="Ví dụ: K65-CNTT-A" className={inputClasses} />
              </div>
            </div>
            ...
            <div className="space-y-1">
              ...
              <div className="relative">
                ...
                <input type="text" placeholder="CLXXX" className={inputClasses} />
              </div>
            </div>
            ...
            <div className="space-y-1">
              ...
              <div className="relative">
                ...
                <input type="text" placeholder="2020-2024" className={inputClasses} />
              </div>
            </div>
